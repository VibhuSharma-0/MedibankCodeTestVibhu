...
public class Headlines {
    ...
    public String getHeadline_source_id() {
        return headline_source_id;
    }

    public void setHeadline_source_id(String headline_source_id) {
        this.headline_source_id = headline_source_id;
    }

    public String getHeadline_source_name() {
        return headline_source_name;
    }

    public void setHeadline_source_name(String headline_source_name) {
        this.headline_source_name = headline_source_name;
    }
    ...
    @ColumnInfo(name = "headlineSourceId")
    private String headline_source_id;
    @ColumnInfo(name = "headlineSourceName")
    private String headline_source_name;

    public Headlines(String headline_title, String headline_desc, String headline_author, String headline_thumbnail, String headline_url, String headline_source_id, String headline_source_name) {
        this.headline_title = headline_title;
        this.headline_desc = headline_desc;
        this.headline_author = headline_author;
        this.headline_thumbnail = headline_thumbnail;
